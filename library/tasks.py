...
def notify_borrowers_async():
    queryset = BorrowingTransaction.objects.select_related("borrower").prefetch_related(
        "books__book", "books__library"
    )
    transactions = [
        transaction
    ...
    for transaction in transactions:
        ...
        html_message = render_to_string(
            "emails/borrowing_reminder_email.html", notify_email_data
        )
        send_mail(
